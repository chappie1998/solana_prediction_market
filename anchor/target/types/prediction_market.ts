...
export type PredictionMarket = {
  address: 'EhcnHR2STHGusK4EqCJ7Bh2UTv9pPFFZTp9h3776A7Tq';
  metadata: {
  ...
  instructions: [
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [121, 101, 115, 95, 116, 111, 107, 101, 110];
              },
              {
                kind: 'account';
                path: 'pool';
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [110, 111, 95, 116, 111, 107, 101, 110];
              },
              {
                kind: 'account';
                path: 'pool';
    ...
    },
    {
      ...
      discriminator: [186, 128, 81, 104, 74, 79, 18, 224];
      accounts: [
        {
          name: 'predictionMarket';
          writable: true;
  ...
  accounts: [
    ...
    {
      name: 'predictionMarket';
      discriminator: [117, 150, 97, 152, 119, 58, 51, 58];
    }
  ];
  errors: [
    {
  ...
  types: [
    {
      name: 'pool';
      docs: ['The structure for individual prediction pools'];
      type: {
        kind: 'struct';
        fields: [
          {
    ...
    {
      name: 'poolStatus';
      docs: ['The possible statuses of a prediction pool'];
      type: {
        kind: 'enum';
        variants: [
          {
    ...
    {
      name: 'predictionMarket';
      docs: ['The main prediction market account structure'];
      type: {
        kind: 'struct';
        fields: [
          {
